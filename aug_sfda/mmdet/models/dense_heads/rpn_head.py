...
class RPNHead(AnchorHead):
    ...
    def loss_by_feat(self,
        ...
        losses = super().loss_by_feat(
            cls_scores,#len(cls_scores) cls_scores[4].size()
            bbox_preds,#len(bbox_preds) bbox_preds[1].size()
            batch_gt_instances,#len(batch_gt_instances) batch_gt_instances[0]
            batch_img_metas,#len(batch_img_metas) batch_img_metas[0]
            batch_gt_instances_ignore=batch_gt_instances_ignore)#len(batch_gt_instances_ignore) batch_gt_instances_ignore[0]
        return dict(
