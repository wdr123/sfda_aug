...
classes = ('car', 'person', 'bus','bike','motor','rider','truck','train',)
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            ...
            data_prefix=dict(img='leftImg8bit_trainval_rain/leftImg8bit_rain/train/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='leftImg8bit_trainval_rain/leftImg8bit_rain/val/'),
        test_mode=True,
        filter_cfg=dict(filter_empty_gt=True, min_size=32),
