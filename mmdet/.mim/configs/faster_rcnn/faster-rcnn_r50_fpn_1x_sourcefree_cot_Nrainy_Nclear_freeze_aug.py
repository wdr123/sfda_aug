_base_ = [
    '../_base_/models/faster-rcnn_r50_fpn_aug.py',
     '../_base_/datasets/night_sunny1.py',
    '../_base_/schedules/schedule_1x.py', '../_base_/default_runtime.py'
]
style_stats_path_src = './data/night_rainy_aug/night_sunny'
style_stats_path_tgt = './data/night_rainy_aug/day_clear'
src_ckp_list = [
...
load_from = './work_dirs/faster-rcnn_r50_fpn_1x_source_night_rainy/epoch_8.pth'
model = dict(
...
param_scheduler = [
    dict(
        type='LinearLR', start_factor=0.000001, by_epoch=False, begin=0, end=500),
    dict(
        type='MultiStepLR',
        begin=0,
        end=8,
