...
# src_ckp_list = ['./work_dirs/faster-rcnn_r50_fpn_1x_dusk_rainy/epoch_8.pth',
#                 './work_dirs/faster-rcnn_r50_fpn_1x_dusk_rainy/epoch_8.pth',
#                 './work_dirs/faster-rcnn_r50_fpn_1x_dusk_rainy/epoch_8.pth',
#                 './work_dirs/faster-rcnn_r50_fpn_1x_dusk_rainy/epoch_8.pth' 
# ]
...
num_src=len(src_ckp_list)
train_cfg = dict(type='MSFEpochBasedTrainLoop',ckpt_list=src_ckp_list,num_src=num_src,max_epochs=10,val_interval=1)
test_cfg=dict(
        rpn=dict(
            nms_pre=1000,
            max_per_img=1000,
